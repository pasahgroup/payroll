                        ...
                        <form action="{{ route('front.setting.submit') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.about_us_image') (800X800)<span
                                                class="validateRq">*</span></label>
                                        <img src="{{ url('uploads/front/' . $setting->about_us_image) }}"
                                            style="max-height: 200px;">
                                        <input type="file" class="form-control" name="about_us_image"
                                            placeholder="@lang('front.about_us_image')">
                                    </div>

                                    <div class="col-md-9 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.about_us_description')<span
                                                class="validateRq">*</span></label>
                                        <textarea style="min-height: 200px;" class="form-control" placeholder="@lang('front.about_us_description')"
                                            name="about_us_description">{!! $setting->about_us_description !!}</textarea>
                                    </div>

                                    <!-- contact  -->
                                    <div class="col-md-3 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.contact_website')<span
                                                class="validateRq">*</span></label>
                                        <input type="text" class="form-control" name="contact_website"
                                            placeholder="@lang('front.contact_website')" value="{{ $setting->contact_website }}">
                                    </div>
                                    ...
                                    <div class="col-md-3 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.show_about_section')<span
                                                class="validateRq">*</span></label>
                                        <select type="text" class="form-control" name="show_about"
                                            placeholder="@lang('front.show_about_section')">
                                            <option @if ($setting->show_about == 1) selected @endif value="1">
                                                Yes
                                            </option>
                                            <option @if ($setting->show_about == 0) selected @endif value="0">No
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.show_contact_section')<span
                                                class="validateRq">*</span></label>
                                        <select type="text" class="form-control" name="show_contact"
                                            placeholder="@lang('front.show_contact_section')">
                                            <option @if ($setting->show_contact == 1) selected @endif value="1">
                                                Yes
                                            </option>
                                            <option @if ($setting->show_contact == 0) selected @endif value="0">No
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 mt-1" style="margin-top:10px;">
                                        <label class="control-label">@lang('front.show_counter_section')<span
                                                class="validateRq">*</span></label>
                                        <select type="text" class="form-control" name="show_counter"
                                            placeholder="@lang('front.show_counter_section')">
                                            <option @if ($setting->show_counter == 1) selected @endif value="1">
                                                Yes
                                            </option>
                                            <option @if ($setting->show_counter == 0) selected @endif value="0">No
                                            </option>
                                        </select>
                                    </div>
