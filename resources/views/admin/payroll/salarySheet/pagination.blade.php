	...
	<table class="table table-bordered">
		<thead>
			 <tr class="tr_header">
				...
				<th>@lang('salary_sheet.total_allowance')</th>
				<th>@lang('paygrade.gross_salary')</th>
				<th>@lang('salary_sheet.total_deduction')</th>
				...
				@foreach($results AS $value)
					<tr>
						...
						<td>{!! number_format($value->basic_salary) !!}</td>
							<td>{!! number_format($value->total_allowance) !!}</td>
						<td>{!! number_format($value->gross_salary+$value->total_deduction) !!}</td>
						<td>{!! number_format($value->total_deduction) !!}</td>
