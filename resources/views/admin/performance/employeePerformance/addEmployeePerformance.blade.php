            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'employeePerformance.store', 'enctype' => 'multipart/form-data', 'id' => 'payGradeForm', 'class' => 'ajaxFormSubmit', 'data-redirect' => route('employeePerformance.index')]) }}
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control required monthField" readonly="readonly"
                                            id="month" placeholder="@lang('common.month')" name="month"
                                            type="text">
                                    </div>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" name="rating[]" max="10"
                                                            class="form-control" placeholder="EX: 6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" name="rating[]" max="10"
                                                                    class="form-control"
                                                                    placeholder="@lang('performance.rating')">
                                                                <input type="hidden" name="performance_criteria_id[]"
